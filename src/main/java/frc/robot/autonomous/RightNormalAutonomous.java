...
public class RightNormalAutonomous extends CommandGroup {
  ...
  public double distanceToGoalX = 8; //replace with actual value, this is the distance from your position once you have crossed the initiation line to the goal
  public double distanceToGoalY = 8; //replace with actual value
  public double timeout = 8; //replace with actual value
  public double speed = 0.8;

  public RightNormalAutonomous() {
