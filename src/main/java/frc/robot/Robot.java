...
public class Robot extends TimedRobot {
    ...
    public void robotInit() {
        ...
        UserInterface.operatorController.LB.whenPressed(new ClimberExtend()); //RBump: Extend climber (turns brake off as well)
    ...
    public void teleopPeriodic() {
        ...
        if (RobotMap.arePinsOut) {
            if (UserInterface.operatorController.getLeftTrigger() >= 0.1) {
                Subsystems.climber.contractClimber(UserInterface.operatorController.getLeftTrigger());
            } else if (UserInterface.operatorController.LB.get()) {
