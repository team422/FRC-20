...
public class ShuffleboardControl {
    ...
    private static NetworkTableEntry blockXWidget;
    ...
    public static void layoutShuffleboard() {
        ...
        //controls that aren't actually controls
        ...
        blockXWidget = controlsLayout.add("Block x", -404).getEntry();
    }
    ...
    public static void printDataToShuffleboard() {
        ...
        try {
            ...
            blockXWidget.setDouble(block.getX());
        } catch (java.lang.NullPointerException e) {
            blockXWidget.setDouble(-404);
        }
    }
